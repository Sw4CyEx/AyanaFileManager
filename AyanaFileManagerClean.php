...
$config = [
    'judul_filemanager' => 'Manajer File PHP Pro v9 - Enkripsi Konfig Log',
...
// --- FUNGSI LOGGING (Sama seperti v8) ---
...
elseif (check_login() || !$config['aktifkan_login']) {
    $msg = ""; $type = "info"; 
    // ... (Aksi upload, create_folder, create_file, dst. SAMA SEPERTI SEBELUMNYA) ...
...
<?php else: // Tampilan utama file manager ?>
    ...
    <div class="container">
        ...
        <div class="toolbar">
            ...
            <div class="main-actions" style="display:flex; gap: 0.5rem; flex-wrap:wrap;">
                ...
                <button onclick="showModal('loggingSettingsModal')" class="btn btn-secondary glitch-hover"><span class="icon">⚙️</span> Pengaturan Log</button>
    ...
    <div id="loggingSettingsModal" class="modal" <?php if(isset($_GET['show_logging_settings'])) echo 'style="display:flex;"'; ?>>
        <div class="modal-content">
            ...
            <div class="modal-header"><h4><span class="icon">⚙️</span> Pengaturan Logging</h4></div>
    ...
    <?php endif; ?>
    <div class="footer"><p>&copy; <?php echo date("Y"); ?> <?php echo htmlspecialchars($config['judul_filemanager']); ?>. Dibuat dengan PHP.</p></div>
<?php endif; ?>
</div>
